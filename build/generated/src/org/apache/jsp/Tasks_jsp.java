 ...
 for (int i = 0; i < catlist.size(); i++) {
  ...
  if (us == null) {
    ...
    if (us.getUserType().getUserType().equals("admin")) {
            ...
            try {
                if (us != null) {
                    ...
                    if (us.getUserType().getUserType().equals("admin")) {
                        ...
                        Query qU = ss.createQuery("from Invoice order by date(date) desc");
                        inv = qU.list();
      ...
      out.write("                            </li>\n");
      out.write("                            \n");
      out.write("                            <li class=\"active\">Tasks</li>\n");
      out.write("                        </ol>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("                <!-- /.row -->\n");
      ...
      out.write("                                <h3 class=\"panel-title\"><i class=\"fa fa-shopping-cart fa-0\"></i> <input type=\"text\" name=\"Srch\" value=\"\" />  Tasks</h3>\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"panel-body\">\n");
      out.write("                                \n");
      out.write("                                 <label><a style=\"text-decoration: none\" href=\"");
      out.print(url);
      out.write("&status=4\"> <input type=\"radio\" name=\"actiontype\" value=\"Purchased\"/>  Purchased </a></label>\n");
      out.write("                                <span><a style=\"text-decoration: none\" href=\"");
      out.print(url);
      out.write("&status=5\"> <input type=\"radio\" name=\"actiontype\" value=\"Dispatch\" />  Dispatch</a></span> \n");
      out.write("                                <span><a style=\"text-decoration: none\" href=\"");
      out.print(url);
      out.write("&status=6\"> <input type=\"radio\" name=\"actiontype\" value=\"Confirmed\" />  Confirmed</a></span> \n");
      out.write("                                <span><a style=\"text-decoration: none\" href=\"");
      out.print(url);
      out.write("&status=1\"> <input type=\"radio\" name=\"actiontype\" value=\"Deliverd\" />  Delivered</a></span> \n");
      out.write("                                <span><a style=\"text-decoration: none\" href=\"");
      out.print(url);
      out.write("&status=1\">  <input type=\"radio\" name=\"actiontype\" value=\"Declined\" />  Declined</a></span> \n");
      out.write("                                <span> <a style=\"text-decoration: none\" href=\"");
      out.print(url);
      out.write("&status=1\">  <input type=\"radio\" name=\"actiontype\" value=\"All\" checked=\"checked\" />All</a></span> \n");
      out.write("                        ");
      ...
      out.write("                                                <th>Invoice Date/Time</th>\n");
      out.write("                                                <th>User Name</th>\n");
      out.write("                                                <th>Status</th>\n");
      out.write("\n");
      out.write("                                                <th>P. Method</th>\n");
      ...
      out.print(i.getUser().getIduser());
      out.write('"');
      out.write('>');
      out.print(i.getUser().getFname() + " " + i.getUser().getLname());
      out.write("</a></td>\n");
      out.write("                                                <td>");
      ...
      out.write("\n");
      out.write("                                                <td>");
      out.print(i.getPaymentMethod().getPaymentMethod());
      out.write("</td>\n");
      out.write("                                                <td>\n");
      out.write("                                                    <form action=\"view_inv.jsp\" >\n");
      out.write("                                                        <input type=\"hidden\" name=\"invid\" value=\"");
      out.print(i.getIdinvoice());
      out.write("\">\n");
      out.write("                                                        <button class=\"btn btn-warning\"   >View</button>\n");
      out.write("                                                        \n");
      out.write("                                                    </form>\n");
      out.write("\n");
      out.write("                                                </td>\n");
      ...
      out.write("                              <br/>\n");
      out.write("                              <br/>\n");
      out.write("                              <i>You have No Oders</i>\n");
      out.write("                              \n");
      out.write("                              ");
      ...
      out.write("\n");
      out.write("                                <li class=\"active\">\n");
      out.write("                                    <a  href=\"Tasks.jsp?page=");
