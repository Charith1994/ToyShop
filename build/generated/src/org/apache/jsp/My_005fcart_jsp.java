...
public final class My_005fcart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("        <script src=\"myjs/forcart.js\" type=\"text/javascript\"></script>\n");
      out.write("        \n");
      out.write("    </head>\n");
      out.write("\n");
      out.write("\n");
 ...
 for (int i = 0; i < catlist.size(); i++) {
  ...
  if (us == null) {
    ...
    if (us.getUserType().getUserType().equals("admin")) {
      ...
      out.write("                            <li>\n");
      out.write("                                <i class=\"fa fa-home\"></i>  <a href=\"dash_board.jsp\">Dash Board</a>\n");
      out.write("                            </li>\n");
      out.write("                            <li class=\"active\"><span class=\"panel-title\"><i class=\"fa fa-shopping-cart\"></i> My Cart</span></li>\n");
      out.write("                        </ol>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("                <!-- /.row -->\n");
      ...
      out.write("                                <h3 class=\"panel-title\"><i class=\"fa fa-shopping-cart\"></i>\n");
      out.write("                                    My Cart</h3>\n");
      out.write("                            </div>\n");
      ...
      out.write("                                                    \n");
      out.write("                                                    <th style=\"width: 200px; \">Quantity</th>\n");
      ...
      out.print(lg.getImage());
      out.write("\" width=\"120\" height=\"60\"></td>\n");
      out.write("                                                <td><span><input type=\"hidden\" value=\"");
      out.print( lg.getIdproduct());
      out.write("\" class=\"prodid\">");
      out.print( lg.getIdproduct());
      out.write("</span></td>\n");
      out.write("                                              <td >");
      out.print( lg.getProduct());
      ...
      out.write("                                                <td >");
      out.print(ni.getQty());
      out.write("<input type=\"number\" min=\"1\"   style=\"width: 40px ;\"  value=\"1\" id=\"qtychng\" class=\"Qty\" ><button  style=\"padding: 4px \"  class=\" ed glyphicon glyphicon-edit\" type=\"button\"></button></td>\n");
      out.write("                                                <td >   RS:");
      out.print( df.format(lg.getSellingPrice()));
      out.write(" </td>\n");
      out.write("                                                <td id=\"totl\"><span class=\"val\">RS:");
      out.print(df.format(ni.getQty() * lg.getSellingPrice()));
      out.write("</span></td>\n");
      out.write("                                                <td>\n");
      out.write("                                                    <form action=\"invoice.jsp\">\n");
      ...
      out.write("\" name=\"pid\"/>   \n");
      out.write("\n");
      out.write("                                                        <button class=\"btn btn-primary glyphicon glyphicon-shopping-cart\"> Purchase</button>\n");
      out.write("\n");
      out.write("\n");
      out.write("                                                    </form>\n");
      out.write("                                                    <form action=\"delete_from_cart\">\n");
      ...
      out.print(url);
      out.write("\" name=\"url\"/>\n");
      out.write("                                                        <button class=\"btn btn-danger glyphicon glyphicon-remove\" style=\"padding-right: 18px\"> Remove</button>\n");
      out.write("                                                    </form>\n");
      out.write("                                                </td>\n");
      out.write("                                            </tr>\n");
      out.write("\n");
      ...
      out.print(ni.getProduct().getIdproduct());
      out.write("\" class=\"prodid\">");
      out.print(ni.getProduct().getIdproduct());
      out.write("</td>\n");
      out.write("                                                <td>");
      out.print(ni.getProduct().getProduct());
      out.write("</td>\n");
      out.write("                                                <td><span id=\"qty\" >");
      out.print(ni.getQty());
      out.write("</span><input min=\"1\"  style=\"width: 40px;\" type=\"number\" value=\"1\" class=\"Qty\" ><button  style=\"padding: 4px\"  class=\" ed glyphicon glyphicon-edit\" type=\"button\"></button></td>\n");
      out.write("                                                \n");
      out.write("                                                <td>RS:");
      out.print( df.format(ni.getProduct().getSellingPrice()));
      out.write("</td>\n");
      out.write("                                                <td id=\"totl\">RS:");
      out.print(df.format(Integer.parseInt(ni.getQty()) * ni.getProduct().getSellingPrice()));
      out.write("</td>\n");
      out.write("                                                <td>\n");
      out.write("                                                    <form action=\"invoice.jsp\" method=\"POST\">\n");
      out.write("                                                        <input type=\"hidden\" value=\"");
      out.print(ni.getIdcartReg());
      out.write("\" name=\"cart_reg_id\"/>   \n");
      out.write("\n");
      ...
      out.write("                                            </tbody>\n");
      out.write("                                        </table>\n");
      out.write("                                        <span class=\"btn btn-primary\" onclick=\"location.href = 'Products_SERCH_2.jsp';\">Go Back To Shopping</span>\n");
      out.write("                                        <span class=\"btn btn-success\" onclick=\"location.href = 'invoice.jsp';\">Pay For All Iteam</span><br/>\n");
      out.write("\n");
      out.write("                                        <label> *If yo going to pay all items at once, Dilivery cost may charge only at one time.</label>                                     \n");
      out.write("                                    </div>\n");
      out.write("                                </div>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
