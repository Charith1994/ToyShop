...
public final class uprofile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("            function my_navBar(a) {\n");
      out.write("                $.post(a, \"\", function (data) {\n");
      out.write("\n");
      out.write("                    $(\"#probody\").html(data);\n");
      out.write("                });\n");
      out.write("\n");
      out.write("\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            function load_add_new() {\n");
      out.write("                $('#probody').load('Add_new_toy.jsp');\n");
      out.write("\n");
      out.write("            }\n");
      out.write("            \n");
      out.write("            function load_report_view() {\n");
      out.write("                $('#probody').load('report_view.jsp');\n");
      out.write("url='report_view.jsp';\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            function load_dash() {\n");
      out.write("                $('#probody').load('dash_board.jsp');\n");
      out.write("\n");
      out.write("            }\n");
      out.write("            function load_cart() {\n");
      out.write("                $('#probody').load('My_cart.jsp');\n");
      out.write("\n");
      out.write("            }\n");
      out.write("            \n");
      out.write("            function load_details() {\n");
      out.write("                $('#probody').load('user_detail.jsp');\n");
      out.write("\n");
      out.write("            }\n");
      out.write("\n");
      out.write("\n");
      out.write("            function add(a) {\n");
      out.write("                alert(\"sdasa\");\n");
      out.write("                var b = $('#pn').val();\n");
      out.write("                var c = $('#pw').val();\n");
      out.write("                alert(a);\n");
      out.write("                alert(b);\n");
      out.write("                $('#probody').load('Add_new_batch.jsp?id=' + a + '&product=' + b + '&weight=' + c);\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("            }\n");
      out.write("            \n");
      out.write("            \n");
      out.write("          function loadwhenload(){\n");
      out.write("               \n");
      out.write("               url=");
      ...
      out.write("\n");
      out.write("        <link href=\"favicon.ico\" />\n");
      out.write("\n");
      out.write("    </head>\n");
      out.write("    <body onload=\"load_dash()()\">\n");
      out.write("\n");
      out.write("        ");
      out.write("\r\n");
      out.write("\r\n");
 ...
 for (int i = 0; i < catlist.size(); i++) {
  ...
  if (us == null) {
    ...
    if (us.getUserType().getUserType().equals("admin")) {
      ...
      out.write("                                <a style=\"margin: 4px\" class=\"form-control btn btn-primary\" onclick=\"load_dash()\"><span style=\"padding-right:10px \" id=\"basic-addon1\"><span class=\"glyphicon glyphicon-user\"></span></span>My dashboard</a><br/>\n");
      out.write("                                <!--<a style=\"margin: 4px\" class=\"form-control btn btn-primary\" onclick=\"my_navBar('my_products')\"><i style=\"padding-right: 10px\" class=\" fa fa-product-hunt\" aria-hidden=\"true\" ></i>My Products</a><br/>-->\n");
      out.write("                              ");

                              if(us!=null && us.getUserType().equals("admin")){
                              
      out.write("\n");
      out.write("                                <a style=\"margin: 4px\" class=\"form-control btn btn-primary\" onclick=\"load_add_new()\"><i style=\"padding-right: 10px\"  class=\" fa fa-adn\" aria-hidden=\"true\" ></i>Add new product</a><br/>\n");
      out.write("                               \n");
      out.write("                                ");
      ...
      out.write("\n");
      out.write("                                <a style=\"margin: 4px\" class=\"form-control btn btn-primary\" onclick=\"load_cart()\"><i style=\"padding-right: 10px\"  class=\" fa fa-adn\" aria-hidden=\"true\" ></i>My Cart</a><br/>\n");
      out.write("                                <a style=\"margin: 4px\" class=\"form-control btn btn-primary\" onclick=\"load_details()\"><i style=\"padding-right: 10px\"  class=\" fa fa-adn\" aria-hidden=\"true\" ></i>My Details</a><br/>\n");
      out.write("\n");
      out.write("\n");
      out.write("                            </div>\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("                            <div id=\"probody\" class=\"col-lg-10\" >\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("                            </div>\n");
