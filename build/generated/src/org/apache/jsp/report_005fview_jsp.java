...
public final class report_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            $(function () {\n");
      out.write("\n");
      out.write("                $(\".reply\").click(\n");
      out.write("                        function () {\n");
      out.write("\n");
      out.write("                            var selectButn = $(this).parent().parent();\n");
      out.write("                            var reply2 = $(selectButn).find('#reply').val();\n");
      out.write("                            var id = $(selectButn).find('#inid').val();\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("                            $.post(\"report_reply\", {id: id, reply: reply2}, function (data) {\n");
      out.write("\n");
 ...
 for (int i = 0; i < catlist.size(); i++) {
  ...
  if (us == null) {
    ...
    if (us.getUserType().getUserType().equals("admin")) {
      ...
      out.write("                            </li>\n");
      out.write("                            <li class=\"active\"><span class=\"panel-title\"><i class=\"fa fa-warning\"></i> Reported from customer</span></li>\n");
      out.write("                        </ol>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("                <!-- /.row -->\n");
...
boolean flag=false;
      ...
      out.write("                                                            <h3 class=\"panel-title\"><i class=\"fa fa-warning\"></i>\n");
      out.write("                                                                Reported</h3>\n");
      out.write("                                                        </div>-->\n");
      ...
      out.write("\n");
      out.write("                                                    <td>");
      out.print(i.getInvoice().getIdinvoice());
      out.write("</td>\n");
      out.write("                                                    <td>");
      out.print(i.getInvoice().getUser().getFname() + " " + i.getInvoice().getUser().getLname());
      out.write("</td>\n");
      out.write("                                                    <td>");
      out.print(i.getInvoice().getUser().getTelnumber());
      out.write("</td>\n");
      out.write("                                                    <td>");
      out.print(i.getReason());
      out.write("</td>\n");
      out.write("                                                    <td>");
   ...
   if(flag){         
      out.write("\n");
      out.write("                                                        \n");
      out.write("                                                        <input type=\"hidden\" id=\"inid\" value=\"");
      out.print(i.getIdReport());
      out.write("\"><button class=\"btn btn-info reply \"  > Take action</button>\n");
      out.write("                                                    \n");
      out.write("                                                        ");
 } else{
      ...
      out.write("\n");
      out.write("                                        <i>You have No Reports</i>\n");
      out.write("\n");
      out.write("                                        ");
      ...
      out.write("\n");
      out.write("                                        <!--<span class=\"btn btn-success\" onclick=\"location.href ='Add_product.html';\">Pay For All Iteam</span><br/>-->\n");
      out.write("                                    </div>\n");
      out.write("                                </div>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      ...
      out.write("\n");
      out.write("                            <li class=\"active\">\n");
      out.write("                                <a  href=\"report_view.jsp?url=report_view.jsp&page=");
