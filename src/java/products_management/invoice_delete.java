 ...
 * @author ZEE
 */
@WebServlet(name = "invoice_delete", urlPatterns = {"/invoice_delete"})
public class invoice_delete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int invid=Integer.parseInt(request.getParameter("invid"));
                ...
                int a=8;
                ActiveState act=(ActiveState) hbs.load(ActiveState.class, a);
                
                
                Transaction tr=hbs.beginTransaction();
                
                i.setActiveState(act);
                hbs.update(i);
                tr.commit();
                
                
                String url=request.getParameter("url");
                response.sendRedirect(url+"&invid="+invid);
        }
    }
